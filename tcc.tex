...
\textoResumo {  Redes de sensores s\~ao utilizadas para a capta\c{c}\~ao, processamento de informa\c{c}\~ao\
    ...
    Os n\'os destas redes possuem processadores, transmissores e receptores simplificados, que possuem restri\c{c}\~oes\
    de mem\'oria, processamento, energia e comunica\c{c}\~ao. Contudo estes dispositivos apresentam um custo\
    ...
    CoAP pode tornar vi\'avel a cria\c{c}\~ao de aplica\c{c}\~oes web em redes de sensores sem fio por um baixo custo.
