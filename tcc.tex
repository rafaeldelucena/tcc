...
\agradecimento{Agrade\c{c}o a toda minha fam\'ilia, amigos e professore que colaboraram com o trabalho.}
...
\palavrasChave{internetworking WSN GPRS CoAP IoT}
...
\capa
\folhaderosto[comficha]%[comficha] % Se nao quiser imprimir a ficha, é só não usar o parâmetro
%\folhaaprovacao
%\paginadedicatoria
%\paginaagradecimento
%\paginaepigrafe
...
\abreviatura{TCP}{Transmission Control Protocol}
...
\abreviatura{RTT}{Round-Trip Time}
\abreviatura{WSDL}{Web Services Description Language}
\abreviatura{ELF}{Executable and Linkable Format}
