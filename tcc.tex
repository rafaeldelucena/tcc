...
\textoResumo {  Redes de sensores s\~ao utilizadas para a captura e processamento de informa\c{c}\~ao\
    para atua\c{c}\~ao sobre um ambiente, tornando-as importantes em aplica\c{c}\~oes de controle, telemetria\
    e rastreamento.
    
    Estas redes s\~ao compostas por n\'os sensores que possuem processadores, transmissores e receptores simplificados,\
    restri\c{c}\~oes de mem\'oria e energia, que trabalham em conjunto afim obter dados de um ambiente. Contudo possuem\
    um custo baixo de equipamentos, tornando interessante a implanta\c{c}\~ao destes sistemas.
